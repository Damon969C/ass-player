...
```text
957b2e6ad9718a050b82b38331f65af2992b0a8bf3205149670e88495cd1dcf6
```
...
- 支持视频/字幕拖拽、播放暂停、按相邻字幕起始点前进/后退、音量调节和进度条跳转；
- 支持沉浸式播放：隐藏工具栏与字幕侧栏，悬浮播放控件在鼠标无操作 2 秒后自动隐藏；外层窗口最大化时进入系统真全屏，按 `Esc` 退出；
